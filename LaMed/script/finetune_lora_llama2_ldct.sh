...
accelerate launch LaMed/src/train/train.py \
    ...
    --cap_data_path /blue/chenaokun1990/tienyuchang/VILA/playground/data/eval/LungCancer_3DCT/Report_notes_train_nii.jsonl \
    --model_type llama2 \
    --lora_enable True \
    --vision_tower vit3d \
    --only-cap \
    --bf16 True \
    --output_dir /orange/chenaokun1990/tienyu/m3d_model/m3d_note_lora_finetune/ \
